...
export const envs = {
    ...
    // Variables para Exactus
    SQLSERVER_EXACTUS_USER: get('SQLSERVER_EXACTUS_USER').required().asString(),
    SQLSERVER_EXACTUS_PASSWORD: get('SQLSERVER_EXACTUS_PASSWORD')
        .required()
        .asString(),
    SQLSERVER_EXACTUS_SERVER: get('SQLSERVER_EXACTUS_SERVER')
        .required()
        .asString(),
    SQLSERVER_EXACTUS_DB_NAME: get('SQLSERVER_EXACTUS_DB_NAME')
        .required()
        .asString(),
