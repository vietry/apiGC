...
export class FotoDemoplotController {
    constructor(private readonly fotoDemoplotService: FotoDemoplotService) {}
    ...
    verificarHash = async (req: Request, res: Response) => {
    ...
    getFotosDemoplots = async (req: Request, res: Response) => {
        ...
        this.fotoDemoplotService
            .getFotosDemoplots(paginationDto!)
    ...
    getFotosByIdDemoplot = async (req: Request, res: Response) => {
        ...
        this.fotoDemoplotService
            .getFotosByIdDemoplot(+idDemoPlot)
            .then((fotoDemoplot) => res.status(200).json(fotoDemoplot))
            .catch((error) => this.handleError(res, error));
    };
