...
export class ColaboradorEntity {
    ...
    public static fromObject(object: {[key: string]: any}): ColaboradorEntity {
        ...
        if (idArea === undefined) throw CustomError.badRequest('idArea is required');
        if (idZonaAnt === undefined) throw CustomError.badRequest('idZonaAnt is required');
        if (idNegocio === undefined) throw CustomError.badRequest('idNegocio is required');
        if (idUsuario === undefined) throw CustomError.badRequest('idUsuario is required');
