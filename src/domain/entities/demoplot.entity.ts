...
export class DemoPlotEntity {
    ...
    public static fromObject(object: { [key: string]: any }): DemoPlotEntity {
        const {
            id, titulo, objetivo, hasCultivo, programacion, instalacion, seguimiento, finalizacion, presentacion,
            estado, gradoInfestacion, dosis, validacion, resultado,diaCampo , idCultivo, idContactoP,
            idBlanco, idDistrito, idFamilia, idGte, venta, fecVenta, cantidad, importe,
            //createdAt, 
            createdBy, 
            //updatedAt, 
            updatedBy
        ...
        return new DemoPlotEntity(
            id, titulo, objetivo, hasCultivo, programacion, instalacion, seguimiento, finalizacion, presentacion,
            estado, gradoInfestacion, dosis, validacion, resultado, diaCampo, idCultivo, idContactoP,
            idBlanco, idDistrito, idFamilia, idGte, fecVenta, venta, cantidad, importe,
                       //createdAt, 
                       createdBy, 
                       //updatedAt, 
                       updatedBy,
